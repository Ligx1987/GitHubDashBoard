...
const PROJECT_SEEDS = [
  ['openai/whisper', 'Whisper', 'OpenAI 开源的多语言语音识别模型，语音转文字', 'ai', 'Python', 109529, 13286, 2, 2100, 2350, 151, 'MIT', ['speech-to-text', 'audio', 'deep-learning'], '2022-09-21'],
  ['ollama/ollama', 'Ollama', '在本地一键运行各类开源大语言模型', 'ai', 'Go', 181552, 17982, 8, 7400, 7800, 4064, 'MIT', ['llm', 'local-ai', 'golang'], '2023-06-15'],
  ['huggingface/transformers', 'Transformers', 'Hugging Face 预训练模型库，支持 PyTorch/TensorFlow/JAX', 'ai', 'Python', 166574, 34661, 60, 380, 1500, 2390, 'Apache-2.0', ['nlp', 'transformers', 'pytorch'], '2018-10-11'],
  ['langchain-ai/langchain', 'LangChain', '基于大语言模型构建应用的编排开发框架', 'ai', 'Python', 146957, 24587, 1500, 6800, 7400, 561, 'MIT', ['llm', 'agents', 'python'], '2022-10-17'],
  ['microsoft/semantic-kernel', 'Semantic Kernel', '微软出品的 LLM 集成 SDK，把 AI 能力嵌入应用', 'ai', 'C#', 28593, 4787, 640, 2900, 3200, 320, 'MIT', ['ai', 'agents', 'dotnet'], '2023-03-17'],
  ['microsoft/vscode', 'Visual Studio Code', '微软开源的轻量强大的代码编辑器', 'developer-tools', 'TypeScript', 192830, 43012, 126, 540, 1900, 21152, 'MIT', ['editor', 'electron', 'typescript'], '2015-11-18'],
  ['neovim/neovim', 'Neovim', '可高度扩展的 Vim 编辑器升级版', 'developer-tools', 'Lua', 102541, 7131, 108, 430, 1480, 1917, 'NOASSERTION', ['vim', 'editor', 'lua'], '2014-11-10'],
  ['astral-sh/uv', 'uv', '极快的 Python 包管理器和项目管理工具', 'developer-tools', 'Rust', 90117, 3607, 2100, 2200, 2250, 2919, 'Apache-2.0', ['python', 'packaging', 'rust'], '2024-02-26'],
  ['zed-industries/zed', 'Zed', 'Atom 原班团队打造的高性能协作代码编辑器', 'developer-tools', 'Rust', 90792, 10745, 1600, 4300, 4700, 3162, 'NOASSERTION', ['editor', 'rust', 'collaboration'], '2023-08-30'],
  ['denoland/deno', 'Deno', '现代化的 JavaScript/TypeScript 运行时，Node 的替代品', 'developer-tools', 'Rust', 108486, 6381, 300, 1400, 1550, 1612, 'MIT', ['javascript', 'typescript', 'runtime'], '2018-05-15'],
  ['facebook/react', 'React', 'Meta 开源的构建网页与原生界面的 UI 库', 'web', 'JavaScript', 250673, 51402, 210, 500, 2140, 1374, 'MIT', ['react', 'javascript', 'frontend'], '2013-05-24'],
  ['vercel/next.js', 'Next.js', '基于 React 的全栈 Web 开发框架', 'web', 'JavaScript', 142413, 32653, 30, 240, 980, 3464, 'MIT', ['react', 'nextjs', 'framework'], '2016-10-25'],
  ['sveltejs/svelte', 'Svelte', '编译型前端框架，代码量少、运行性能好', 'web', 'TypeScript', 88172, 5994, 18, 140, 560, 1098, 'MIT', ['svelte', 'frontend', 'compiler'], '2016-11-20'],
  ['tailwindlabs/tailwindcss', 'Tailwind CSS', '原子化工具类 CSS 框架，快速搭建自定义界面', 'web', 'TypeScript', 97651, 6326, 28, 220, 900, 77, 'MIT', ['css', 'tailwindcss', 'frontend'], '2017-10-25'],
  ['vuejs/core', 'Vue', '渐进式 JavaScript 前端框架', 'web', 'TypeScript', 54422, 9209, 140, 320, 1370, 890, 'MIT', ['vue', 'javascript', 'frontend'], '2013-07-29'],
  ['remix-run/remix', 'Remix', '基于 React 的全栈 Web 框架（现归 Shopify）', 'web', 'TypeScript', 33369, 2789, 12, 90, 380, 22, 'MIT', ['react', 'web', 'framework'], '2021-11-22'],
  ['kubernetes/kubernetes', 'Kubernetes', '生产级容器编排与调度系统，云原生基础设施核心', 'infra', 'Go', 127935, 44867, 96, 290, 1230, 3096, 'Apache-2.0', ['kubernetes', 'containers', 'cloud'], '2014-06-07'],
  ['docker/compose', 'Compose', '用 YAML 定义并运行多容器 Docker 应用', 'infra', 'Go', 38206, 5835, 10, 80, 320, 96, 'Apache-2.0', ['docker', 'containers', 'orchestration'], '2014-07-29'],
  ['hashicorp/terraform', 'Terraform', '基础设施即代码（IaC）工具，用配置管理云资源', 'infra', 'Go', 49714, 10624, 120, 250, 980, 1928, 'NOASSERTION', ['terraform', 'infrastructure', 'cloud'], '2014-07-19'],
  ['grafana/grafana', 'Grafana', '开源数据可视化与监控面板', 'infra', 'Go', 76876, 14773, 180, 460, 1840, 3314, 'AGPL-3.0', ['observability', 'monitoring', 'dashboards'], '2013-12-11'],
  ['prometheus/prometheus', 'Prometheus', '监控告警系统与时序数据库', 'infra', 'Go', 66196, 10851, 98, 270, 1150, 905, 'Apache-2.0', ['monitoring', 'metrics', 'kubernetes'], '2012-11-24'],
  ['apache/airflow', 'Apache Airflow', '数据工作流编排与调度平台', 'data', 'Python', 46957, 17908, 95, 310, 1290, 2079, 'Apache-2.0', ['data-engineering', 'workflow', 'python'], '2014-10-08'],
  ['dbt-labs/dbt-core', 'dbt Core', '数据仓库中的数据转换与建模工具', 'data', 'Python', 13915, 2581, 120, 800, 2900, 1589, 'Apache-2.0', ['analytics', 'sql', 'data-warehouse'], '2016-07-08'],
  ['pandas-dev/pandas', 'pandas', 'Python 最常用的数据分析与处理库', 'data', 'Python', 49787, 20423, 74, 180, 760, 2605, 'BSD-3-Clause', ['python', 'data-analysis', 'pandas'], '2009-08-20'],
  ['duckdb/duckdb', 'DuckDB', '进程内分析型 SQL 数据库（OLAP），轻量高性能', 'data', 'C++', 41674, 3821, 820, 3500, 3800, 921, 'MIT', ['database', 'olap', 'analytics'], '2018-06-26'],
  ['apache/spark', 'Apache Spark', '大规模数据统一分析计算引擎', 'data', 'Scala', 44033, 29397, 42, 120, 510, 575, 'Apache-2.0', ['big-data', 'spark', 'scala'], '2010-07-16'],
  ['facebook/react-native', 'React Native', '用 React 构建原生移动应用的跨端框架', 'mobile', 'TypeScript', 126703, 25283, 120, 300, 1250, 1155, 'MIT', ['react-native', 'ios', 'android'], '2015-01-09'],
  ['flutter/flutter', 'Flutter', '谷歌跨平台 UI 框架，一套代码跑多端', 'mobile', 'Dart', 179060, 31837, 130, 360, 1560, 13272, 'BSD-3-Clause', ['flutter', 'dart', 'mobile'], '2014-10-23'],
  ['expo/expo', 'Expo', 'React Native 应用的开发、构建与部署平台', 'mobile', 'TypeScript', 52403, 14153, 320, 1900, 4200, 917, 'MIT', ['react-native', 'expo', 'ios'], '2015-04-17'],
  ['supabase/supabase', 'Supabase', '开源 Firebase 替代品，基于 Postgres 的后端服务', 'mobile', 'TypeScript', 110711, 14577, 1300, 5600, 6100, 1081, 'Apache-2.0', ['postgres', 'backend', 'typescript'], '2019-10-12'],
  ['appwrite/appwrite', 'Appwrite', '开源后端服务（BaaS），面向 Web/移动/Flutter 开发者', 'mobile', 'PHP', 57454, 5739, 260, 1300, 2900, 687, 'BSD-3-Clause', ['backend', 'self-hosted', 'mobile'], '2019-08-13'],
  ['ossf/scorecard', 'OpenSSF Scorecard', '开源项目供应链安全健康度评分工具', 'security', 'Go', 5702, 724, 90, 560, 2000, 456, 'Apache-2.0', ['security', 'supply-chain', 'github-actions'], '2020-09-25'],
  // 原始仓库 2017 年；按 2022 年 v3 重写计
  ['trufflesecurity/trufflehog', 'TruffleHog', '扫描代码与历史中泄露的密钥和凭证', 'security', 'Go', 28037, 2594, 340, 1900, 4300, 558, 'AGPL-3.0', ['security', 'secrets', 'scanning'], '2022-01-12'],
  ['aquasecurity/trivy', 'Trivy', '容器镜像漏洞、配置错误与敏感信息扫描器', 'security', 'Go', 38048, 710, 35, 260, 1050, 264, 'Apache-2.0', ['security', 'containers', 'scanner'], '2019-04-11'],
  ['gitleaks/gitleaks', 'Gitleaks', 'Git 仓库敏感信息泄露检测工具', 'security', 'Go', 29456, 2240, 22, 160, 650, 483, 'MIT', ['security', 'git', 'secrets'], '2017-03-02'],
  ...
  ['microsoft/PowerToys', 'PowerToys', '微软官方 Windows 效率工具集（窗口管理、批量改名等）', 'productivity', 'C#', 138953, 8599, 20, 150, 620, 7750, 'MIT', ['windows', 'utilities', 'productivity'], '2019-05-15'],
  ['jesseduffield/lazygit', 'lazygit', 'Git 命令的终端图形界面，操作更省心', 'productivity', 'Go', 82627, 3047, 26, 200, 820, 1053, 'MIT', ['git', 'terminal', 'tui'], '2018-08-08'],
  ['junegunn/fzf', 'fzf', '命令行模糊搜索神器，文件/历史记录秒搜', 'productivity', 'Go', 83223, 3364, 98, 260, 1060, 331, 'MIT', ['terminal', 'cli', 'go'], '2013-08-16'],
  ['ggml-org/llama.cpp', 'llama.cpp', '纯 C/C++ 实现的大模型本地推理引擎，让 LLM 跑在普通电脑上', 'ai', 'C++', 129358, 23658, 45, 300, 1100, 2523, 'MIT', ['llm', 'inference', 'ggml'], '2023-02-26'],
  ['AUTOMATIC1111/stable-diffusion-webui', 'Stable Diffusion web UI', 'Stable Diffusion AI 绘画的经典网页操作界面', 'ai', 'Python', 165091, 31294, 380, 2100, 2350, 2506, 'AGPL-3.0', ['stable-diffusion', 'webui', 'generative-ai'], '2022-08-22'],
  ['comfyanonymous/ComfyUI', 'ComfyUI', '节点式 AI 图像/视频生成工作流界面，可自由拼装流程', 'ai', 'Python', 134750, 15953, 1900, 5400, 5900, 4923, 'GPL-3.0', ['stable-diffusion', 'diffusion', 'gui'], '2023-01-15'],
  ['tokio-rs/tokio', 'Tokio', 'Rust 异步编程的运行时基础设施', 'developer-tools', 'Rust', 33216, 3762, 110, 800, 1700, 446, 'MIT', ['rust', 'async', 'runtime'], '2016-02-25'],
  ['rust-lang/rust-analyzer', 'rust-analyzer', 'Rust 语言服务器，为 IDE 提供智能补全和跳转', 'developer-tools', 'Rust', 16868, 2237, 130, 900, 1600, 1839, 'Apache-2.0', ['rust', 'lsp', 'ide'], '2020-01-20'],
  ['BurntSushi/ripgrep', 'ripgrep', '速度极快的递归文本内容搜索工具（grep 替代品）', 'developer-tools', 'Rust', 68555, 3343, 20, 150, 600, 200, 'Unlicense', ['search', 'regex', 'cli'], '2016-04-12'],
  ['cli/cli', 'GitHub CLI', 'GitHub 官方命令行工具，终端里管仓库/PR/Issue', 'developer-tools', 'Go', 46387, 9070, 25, 190, 760, 1090, 'MIT', ['github', 'cli', 'go'], '2019-09-17'],
  ['axios/axios', 'Axios', '浏览器和 Node.js 常用的 Promise HTTP 请求库', 'web', 'JavaScript', 109209, 11873, 110, 290, 880, 96, 'MIT', ['http', 'client', 'javascript'], '2014-08-24'],
  ['solidjs/solid', 'Solid', '不依赖虚拟 DOM 的高性能前端 UI 库', 'web', 'TypeScript', 36071, 1116, 780, 3300, 3600, 46, 'MIT', ['reactivity', 'frontend', 'jsx'], '2016-04-22'],
  ['storybookjs/storybook', 'Storybook', 'UI 组件独立开发、测试和文档化工作台', 'web', 'TypeScript', 91141, 10464, 22, 170, 680, 1842, 'MIT', ['ui', 'components', 'workshop'], '2016-03-16'],
  ['withastro/astro', 'Astro', '以速度为卖点的内容型网站全栈框架', 'web', 'TypeScript', 62776, 3806, 940, 3900, 4300, 80, 'NOASSERTION', ['astro', 'ssg', 'web'], '2021-03-09'],
  ['argoproj/argo-cd', 'Argo CD', 'Kubernetes 声明式 GitOps 持续交付工具', 'infra', 'Go', 24226, 7873, 150, 850, 2900, 4367, 'Apache-2.0', ['gitops', 'kubernetes', 'cd'], '2018-03-13'],
  ['istio/istio', 'Istio', '服务网格：连接、保护、治理和观测微服务', 'infra', 'Go', 38404, 8373, 12, 95, 380, 516, 'Apache-2.0', ['service-mesh', 'kubernetes', 'microservices'], '2016-12-05'],
  ['helm/helm', 'Helm', 'Kubernetes 应用的包管理器', 'infra', 'Go', 30273, 7795, 10, 80, 320, 469, 'Apache-2.0', ['kubernetes', 'package-manager', 'helm'], '2015-10-15'],
  ['pola-rs/polars', 'Polars', 'Rust 编写的高性能 DataFrame 数据分析库', 'data', 'Rust', 39851, 3128, 30, 220, 900, 2934, 'MIT', ['dataframe', 'rust', 'analytics'], '2020-08-18'],
  ['ClickHouse/ClickHouse', 'ClickHouse', '实时分析型列式数据库，查询速度极快', 'data', 'C++', 50043, 8995, 25, 180, 720, 7899, 'Apache-2.0', ['database', 'analytics', 'olap'], '2016-06-17'],
  ['sigstore/cosign', 'Cosign', '容器镜像签名与验证工具，保障软件供应链安全', 'security', 'Go', 6322, 812, 130, 750, 2000, 161, 'Apache-2.0', ['security', 'signing', 'containers'], '2021-03-30'],
  ['sharkdp/bat', 'bat', '带语法高亮和 Git 集成的 cat 增强版文件查看器', 'productivity', 'Rust', 60557, 2178, 15, 110, 450, 518, 'Apache-2.0', ['terminal', 'rust', 'cli'], '2018-01-08'],
  ['CompVis/stable-diffusion', 'Stable Diffusion', 'Stability AI 开源的潜在扩散文本到图像生成模型', 'ai', 'Python', 73478, 10565, 15, 110, 450, 619, 'NOASSERTION', ['stable-diffusion', 'diffusion', 'generative-ai'], '2022-08-10'],
  ['starship/starship', 'Starship', '极简、高速、可高度定制的终端提示符', 'productivity', 'Rust', 60023, 2673, 18, 140, 560, 1054, 'ISC', ['shell', 'prompt', 'rust'], '2019-04-23'],
  // ---- 2024-2025 年 ----
  ['DavidHDev/react-bits', 'React Bits', '面向 React 的动画组件与背景特效合集', 'web', 'JavaScript', 47961, 2326, 290, 1300, 2600, 2, 'NOASSERTION', ['react', 'animation', 'components'], '2024-07-19'],
  ['charmbracelet/crush', 'Crush', 'Charm 出品的终端 AI 编码助手，可接多家模型', 'developer-tools', 'Go', 28277, 2281, 320, 1500, 3000, 795, 'NOASSERTION', ['ai', 'terminal', 'cli'], '2025-03-05'],
  ['pydantic/pydantic-ai', 'PydanticAI', '基于 Pydantic 的类型安全 AI 智能体框架', 'ai', 'Python', 20133, 2768, 380, 1900, 3900, 965, 'MIT', ['ai-agents', 'pydantic', 'python'], '2024-11-14'],
  ['vllm-project/production-stack', 'vLLM Production Stack', 'vLLM 官方出品的生产部署参考架构与 Helm 套件', 'infra', 'Python', 2630, 509, 140, 680, 1400, 224, 'Apache-2.0', ['llm', 'kubernetes', 'vllm'], '2024-11-08'],
  ['openai/openai-agents-python', 'OpenAI Agents SDK', 'OpenAI 出品的轻量智能体框架，支持多 Agent 工作流', 'ai', 'Python', 29667, 4802, 460, 2300, 4800, 48, 'MIT', ['ai-agents', 'llm', 'workflows'], '2025-03-11'],
  ['google-gemini/gemini-cli', 'Gemini CLI', 'Google 开源的终端 AI 编程助手，基于 Gemini 模型', 'developer-tools', 'TypeScript', 107141, 14624, 620, 2600, 5400, 820, 'Apache-2.0', ['ai', 'cli', 'coding-agent'], '2025-06-25'],
  ['volcengine/verl', 'verl', '字节开源的大模型 RL 训练框架，擅长 Agent 强化学习', 'ai', 'Python', 23591, 4583, 420, 2100, 4500, 1257, 'Apache-2.0', ['rl', 'llm', 'agents'], '2024-07-10'],
  ['microsoft/agent-framework', 'Agent Framework', '微软统一的智能体开发框架，融合 Semantic Kernel 与 AutoGen', 'ai', 'Python', 13763, 2369, 130, 640, 1700, 648, 'MIT', ['agents', 'llm', 'autogen'], '2025-09-15'],
  // ---- 2023-2025 年 ----
  ['nuejs/nue', 'Nue', '贴近 Web 标准的现代前端框架，强调渐进增强与极致性能', 'web', 'JavaScript', 8822, 258, 80, 380, 1100, 76, 'MIT', ['frontend', 'framework', 'web-standards'], '2023-09-12'],
  ['tconbeer/harlequin', 'Harlequin', '运行在终端里的 SQL IDE，支持 DuckDB 与 ClickHouse', 'developer-tools', 'Python', 6416, 178, 60, 300, 850, 32, 'MIT', ['sql', 'terminal', 'duckdb'], '2023-03-21'],
  ...
  ['huggingface/smolagents', 'smolagents', 'Hugging Face 极简智能体框架，核心逻辑不足千行', 'ai', 'Python', 29463, 2991, 180, 900, 2400, 827, 'Apache-2.0', ['agents', 'llm', 'huggingface'], '2024-12-09'],
  ['deepseek-ai/DeepSeek-R1', 'DeepSeek-R1', 'DeepSeek 开源的推理大模型，强化学习驱动思维链', 'ai', 'Python', 91973, 11679, 220, 1100, 2900, 37, 'MIT', ['llm', 'reasoning', 'open-model'], '2025-01-20'],
  ['tensorzero/tensorzero', 'TensorZero', '面向生产环境的 LLM 应用栈，统一网关与优化回路', 'infra', 'Rust', 11720, 970, 90, 460, 1300, 392, 'Apache-2.0', ['llm', 'gateway', 'observability'], '2024-09-10'],
  ['daytonaio/daytona', 'Daytona', '开源的开发环境管理器，秒级创建隔离的开发容器', 'developer-tools', 'Go', 71725, 5647, 130, 640, 1700, 456, 'AGPL-3.0', ['dev-environment', 'containers', 'development'], '2024-04-16'],
  ['QwenLM/Qwen3', 'Qwen3', '通义千问 Qwen3 开源大模型权重与推理代码', 'ai', 'Python', 27656, 2061, 160, 820, 2300, 68, 'Apache-2.0', ['llm', 'qwen', 'open-model'], '2025-04-28'],
  // ---- 2025 年 ----
  ['openai/codex', 'Codex CLI', 'OpenAI 开源的终端 AI 编程助手', 'ai', 'Rust', 126212, 19662, 90, 620, 2400, 18515, 'Apache-2.0', ['ai', 'cli', 'coding-agent'], '2025-04-16'],
  ['bytedance/UI-TARS', 'UI-TARS', '字节开源的多模态 GUI 智能体，能操作桌面与浏览器', 'ai', 'Python', 11518, 883, 70, 380, 1500, 58, 'Apache-2.0', ['agents', 'gui', 'multimodal'], '2025-01-20'],
  ['sst/opencode', 'opencode', '终端里的开源 AI 编程助手，支持多家模型', 'developer-tools', 'TypeScript', 209700, 27675, 110, 640, 2500, 6146, 'MIT', ['ai', 'cli', 'coding'], '2025-05-08'],
  ['voideditor/void', 'Void', '开源的 AI 原生代码编辑器（VS Code 分支）', 'developer-tools', 'TypeScript', 28795, 2650, 80, 460, 1800, 306, 'Apache-2.0', ['editor', 'ai', 'vscode'], '2025-05-29'],
  ['Yonom/assistant-ui', 'assistant-ui', 'React 的 AI 聊天界面组件库，可对接任意后端', 'web', 'TypeScript', 12282, 1195, 60, 380, 1400, 405, 'MIT', ['react', 'ai', 'chat-ui'], '2024-06-05'],
  ['janhq/jan', 'Jan', '离线优先的开源 AI 助手桌面应用', 'productivity', 'TypeScript', 44628, 3051, 55, 380, 1500, 541, 'NOASSERTION', ['ai', 'desktop', 'llm'], '2023-11-06'],
  ['vllm-project/aibrix', 'AIBrix', '构建在 Kubernetes 上的 LLM 推理基础设施', 'infra', 'Python', 5107, 699, 40, 260, 950, 379, 'Apache-2.0', ['llm', 'kubernetes', 'inference'], '2024-06-24'],
  ['kgateway-dev/kgateway', 'kgateway', '基于 Envoy 的 Kubernetes 网关（Gloo 网关演进版）', 'infra', 'Go', 5691, 812, 25, 170, 700, 205, 'Apache-2.0', ['kubernetes', 'gateway', 'envoy'], '2024-11-18'],
  ['promptfoo/promptfoo', 'promptfoo', '对 LLM 应用做红队测试、评估与提示词迭代', 'security', 'TypeScript', 25411, 2367, 45, 290, 1150, 641, 'MIT', ['llm', 'security', 'evals'], '2023-06-14'],
  ['dlt-hub/dlt', 'dlt', 'Python 写的轻量 ELT 数据管道框架', 'data', 'Python', 5887, 608, 35, 220, 880, 442, 'Apache-2.0', ['etl', 'data-pipeline', 'python'], '2022-07-27'],
  ['shorebirdtech/shorebird', 'Shorebird', 'Flutter 应用的代码热更新服务与命令行', 'mobile', 'Dart', 3028, 234, 20, 130, 520, 245, 'NOASSERTION', ['flutter', 'code-push', 'mobile'], '2023-02-14'],
  ['chdb-io/chdb', 'chDB', '嵌入式 ClickHouse 引擎的 SQL 分析库', 'data', 'C++', 2906, 135, 15, 95, 380, 43, 'Apache-2.0', ['olap', 'clickhouse', 'embedded'], '2023-10-07'],
  // ---- 2024 年 ----
  ['xai-org/grok-1', 'grok-1', 'xAI 开源的 314B MoE 大模型权重', 'ai', 'Python', 52234, 8542, 30, 200, 800, 125, 'Apache-2.0', ['llm', 'open-model', 'moe'], '2024-03-17'],
  ['microsoft/PyRIT', 'PyRIT', '微软开源的生成式 AI 安全红队测试框架', 'security', 'Python', 4534, 906, 20, 140, 560, 116, 'MIT', ['ai-security', 'red-team', 'llm'], '2024-02-22'],
  ['grafana/alloy', 'Alloy', 'Grafana 开源的可观测性数据收集器（OTel 发行版）', 'infra', 'Go', 3553, 714, 28, 180, 720, 1244, 'Apache-2.0', ['opentelemetry', 'monitoring', 'collector'], '2024-01-16'],
  ['unitycatalog/unitycatalog', 'Unity Catalog', 'Databricks 开源的 AI 与数据资产目录治理工具', 'data', 'Java', 3539, 673, 15, 100, 420, 447, 'Apache-2.0', ['data-catalog', 'governance', 'unity'], '2024-06-27'],
  ['openbao/openbao', 'OpenBao', 'Linux Foundation 维护的 Vault 开源分支', 'infra', 'Go', 7471, 577, 18, 120, 480, 324, 'MPL-2.0', ['secrets', 'security', 'vault'], '2024-11-12'],
  ['lancedb/lancedb', 'LanceDB', '面向 AI 应用的嵌入式多模态向量数据库', 'data', 'Rust', 11513, 1063, 22, 150, 600, 682, 'Apache-2.0', ['vector-database', 'embeddings', 'ai'], '2023-03-03'],
  ['mendableai/firecrawl', 'Firecrawl', '面向 LLM 的网页抓取与结构化数据提取 API', 'web', 'TypeScript', 183920, 9905, 25, 160, 640, 642, 'AGPL-3.0', ['scraping', 'llm', 'api'], '2024-04-16'],
  ['livekit/livekit', 'LiveKit', '开源的实时音视频通话与流媒体基础设施', 'mobile', 'Go', 21078, 2371, 40, 280, 1100, 195, 'Apache-2.0', ['webrtc', 'real-time', 'audio-video'], '2021-07-19'],
  // ---- 2023 年 ----
  ['Significant-Gravitas/Auto-GPT', 'Auto-GPT', '让 GPT-4 自主拆解并执行目标的早期自治智能体', 'ai', 'Python', 187516, 45996, 25, 150, 600, 553, 'NOASSERTION', ['autonomous-agents', 'gpt', 'ai'], '2023-03-16'],
  ['continuedev/continue', 'Continue', 'IDE 里的开源 AI 编码助手，支持自定义模型', 'developer-tools', 'TypeScript', 36008, 5417, 30, 210, 840, 975, 'Apache-2.0', ['ai', 'ide', 'coding'], '2023-05-17'],
  ['paradedb/paradedb', 'ParadeDB', '基于 PostgreSQL 的开源分析型搜索引擎', 'data', 'Rust', 9301, 461, 14, 95, 380, 210, 'AGPL-3.0', ['postgres', 'elasticsearch', 'analytics'], '2023-04-04'],
  ['protectai/llm-guard', 'LLM Guard', '保护 AI 应用的安全工具集，扫描提示词与输出', 'security', 'Python', 3208, 461, 12, 85, 340, 38, 'MIT', ['llm', 'security', 'guardrails'], '2023-08-01'],
  // ---- 补录：2022/2025 年的真实工程 ----
  ['denoland/fresh', 'Fresh', 'Deno 的全栈 Web 框架，Islands 架构服务端渲染', 'web', 'TypeScript', 13789, 757, 18, 120, 470, 158, 'MIT', ['deno', 'ssr', 'web-framework'], '2022-06-22'],
  ['opencost/opencost', 'OpenCost', 'Kubernetes 集群与工作负载的成本监控工具', 'infra', 'Go', 6755, 886, 15, 100, 420, 312, 'Apache-2.0', ['kubernetes', 'cost', 'monitoring'], '2022-06-21'],
  ['usememos/memos', 'Memos', '开源自托管的轻量备忘录与笔记服务', 'productivity', 'Go', 63295, 4780, 40, 280, 1150, 67, 'MIT', ['notes', 'self-hosted', 'memo'], '2022-06-19'],
  ['t3-oss/t3chat', 't3chat', 'T3 技术栈开源的 AI 聊天全栈应用', 'web', 'TypeScript', 6200, 190, 60, 380, 1500, 95, 'MIT', ['ai', 'nextjs', 'chat'], '2025-03-10'],
  ['lynx-family/lynx', 'Lynx', '字节开源的跨端 UI 框架，一套代码渲染移动端与 Web', 'mobile', 'C++', 15128, 553, 90, 560, 2200, 1270, 'Apache-2.0', ['cross-platform', 'ui-framework', 'mobile'], '2025-03-05'],
  ['google/langextract', 'LangExtract', 'Google 开源的 LLM 信息抽取库，从非结构化文本提取结构化数据', 'data', 'Python', 38660, 2708, 40, 260, 1050, 123, 'Apache-2.0', ['llm', 'nlp', 'extraction'], '2025-05-15'],
  // ---- 2026 年（GitHub 真实数据快照 2026-09-24，按分类取高星代表）----
  ['affaan-m/ECC', 'ECC', 'The agent harness performance optimization system. Skills, instincts, memory, security, and research-first development for Claude Code, Codex, Opencode, Cursor and beyond.', 'ai', 'JavaScript', 266242, 39787, 44, 1231, 9000, 223, 'MIT', ['ai-agents', 'anthropic', 'claude', 'claude-code', 'developer-tools', 'llm', 'mcp', 'productivity'], '2026-01-18'],
  ['DietrichGebert/ponytail', 'ponytail', 'Makes your AI agent think like the laziest senior dev in the room. The best code is the code you never wrote.', 'ai', 'JavaScript', 145081, 7776, 167, 936, 3399, 302, 'MIT', ['agent-skills', 'ai-agents', 'claude', 'claude-code', 'claude-code-plugin', 'cursor-rules', 'developer-tools', 'llm', 'prompt-engineering', 'yagni'], '2026-06-12'],
  ['Graphify-Labs/graphify', 'graphify', 'Turn any codebase, with its docs, SQL schemas, configs, and PDFs, into a queryable knowledge graph. A /graphify skill for Claude Code, Cursor, Codex, and Gemini CLI: local deterministic AST parsing, every edge explained, no vector store.', 'ai', 'Python', 120955, 11663, 0, 2, 461, 1446, 'Apache-2.0', ['ai-agents', 'antigravity', 'ast', 'claude-code', 'code-analysis', 'code-search', 'codex', 'cursor', 'developer-tools', 'gemini', 'graphrag', 'knowledge-graph', 'leiden', 'llm', 'mcp', 'openclaw', 'rag', 'skills', 'tree-sitter'], '2026-04-03'],
  ['JuliusBrussee/caveman', 'caveman', '🪨 why use many token when few token do trick. Viral skill + proxy for coding agents that cuts 65% of tokens by talking like a caveman.', 'ai', 'Go', 107580, 6234, 87, 472, 4369, 129, 'NOASSERTION', ['ai', 'anthropic', 'caveman', 'claude', 'claude-code', 'llm', 'meme', 'prompt-engineering', 'skill', 'tokens'], '2026-04-04'],
  ['nexu-io/open-design', 'open-design', '🎨 Best DeepSeek Harness Design Plugin. The open-source Claude Design alternative. 🖥️ Local-first desktop app. 🖼️ Your coding agent becomes the design engine: prototypes, landing pages, dashboards, slides, images & video — real files, HTML/PDF/PPTX/MP4 export. 🤖 Claude Code / Codex / Cursor / DeepSeek Harness / OpenCode & 20+ CLIs via BYOK.', 'ai', 'TypeScript', 97852, 11353, 58, 1025, 4462, 1106, 'Apache-2.0', ['agent-skills', 'ai-design', 'byok', 'claude-code-for-design', 'claude-design', 'codex-design', 'coding-agents', 'cursor-design', 'deepseek', 'deepseek-harness', 'design-systems', 'desktop-app', 'dsh', 'dsh-plugin', 'figma-alternative', 'hermes-agent', 'local-first', 'prototyping', 'ui-generator', 'vibe-coding'], '2026-04-28'],
  ['karpathy/autoresearch', 'autoresearch', 'AI agents running research on single-GPU nanochat training automatically', 'ai', 'Python', 96689, 13522, 18, 793, 4328, 194, 'NOASSERTION', [], '2026-03-06'],
  ['Leonxlnx/taste-skill', 'taste-skill', 'Taste-Skill - gives your AI good taste. stops the AI from generating boring, generic slop ', 'ai', 'JavaScript', 89635, 6095, 55, 675, 3164, 70, 'MIT', ['agent', 'ai', 'claude', 'claude-code', 'codex', 'coding', 'design', 'frontend', 'lowcode', 'nocode', 'skill', 'skills', 'vibecoding'], '2026-02-19'],
  ['koala73/worldmonitor', 'worldmonitor', 'Real-time global intelligence dashboard. AI-powered news aggregation, geopolitical monitoring, and infrastructure tracking in a unified situational awareness interface', 'ai', 'TypeScript', 87293, 13292, 1, 8, 422, 346, 'AGPL-3.0', ['agent', 'ai', 'dashboard', 'geopolitics', 'mcp', 'mcp-server', 'monitoring', 'news', 'opensource', 'osint', 'palantir', 'situation'], '2026-01-08'],
  ['Panniantong/Agent-Reach', 'Agent-Reach', 'Give your AI agent eyes to see the entire internet. Read & search Twitter, Reddit, YouTube, GitHub, Bilibili, XiaoHongShu — one CLI, zero API fees.', 'ai', 'Python', 85126, 7471, 64, 609, 4908, 162, 'MIT', ['agent-infrastructure', 'ai-agent', 'ai-search', 'automation', 'bilibili', 'claude-code', 'cli', 'cursor', 'free-api', 'llm-tools', 'mcp', 'python', 'reddit-scraper', 'twitter-scraper', 'web-scraper', 'xiaohongshu', 'youtube-transcript'], '2026-02-24'],
  ['Egonex-AI/Understand-Anything', 'Understand-Anything', 'Graphs that teach > graphs that impress. Turn any code into an interactive knowledge graph you can explore, search, and ask questions about. Works with Claude Code, Codex, Cursor, Copilot, Gemini CLI, and more.', 'ai', 'TypeScript', 83925, 7071, 215, 1101, 4638, 304, 'MIT', ['antigravity-skills', 'business-knowledge', 'claude-code', 'claude-skills', 'codebase-analysis', 'codex', 'codex-skills', 'developer-tools-ai-agent', 'gemini-cli-skills', 'karpathy-llm-wiki', 'knowledge-base', 'knowledge-graph', 'memory', 'opencode-skills', 'pi-agent', 'understandcode', 'vibe-coding'], '2026-03-15'],
  ['rtk-ai/rtk', 'rtk', 'CLI proxy that reduces LLM token consumption by 60-90% on common dev commands. Single Rust binary, zero dependencies', 'ai', 'Rust', 81595, 5161, 74, 1248, 4645, 1574, 'Apache-2.0', ['agentic-coding', 'ai-coding', 'anthropic', 'claude-code', 'cli', 'command-line-tool', 'cost-reduction', 'developer-tools', 'llm', 'open-source', 'productivity', 'rust', 'token-optimization'], '2026-01-22'],
  ['stablyai/orca', 'orca', 'Orca is the ADE for working with a fleet of parallel agents. Run any coding agent with your own subscription. Available on desktop, mobile and remote runtime.', 'ai', 'TypeScript', 76702, 5023, 11, 211, 2523, 6682, 'MIT', ['ade', 'agent-ide', 'ai-agents', 'claude-code', 'cli', 'codex', 'cursor-agent', 'devtools', 'ghostty', 'ide', 'mobile-app', 'opencode', 'orchestration', 'parallel-agents', 'pi', 'terminal', 'worktrees', 'yc-backed'], '2026-03-17'],
  ['headroomlabs-ai/headroom', 'headroom', 'Compress tool outputs, logs, files, and RAG chunks before they reach the LLM. 20% fewer tokens for coding agents, 60-95% fewer tokens for JSON, same answers. Library, proxy, MCP server.', 'ai', 'Python', 73660, 5684, 30, 191, 1003, 685, 'Apache-2.0', ['agent', 'ai', 'anthropic', 'claude-code', 'compression', 'context-engineering', 'context-window', 'cursor', 'fastapi', 'langchain', 'llm', 'mcp', 'openai', 'prompt-engineering', 'proxy', 'python', 'rag', 'token-optimization', 'tokens', 'typescript'], '2026-01-07'],
  ['career-ops-hq/career-ops', 'career-ops', 'Open-source AI job search: scan job portals, evaluate listings into a structured A-H report with a global 1-5 score, tailor your CV, track applications — runs locally in your AI coding CLI (Claude Code, Codex, OpenCode, Antigravity…)', 'ai', 'JavaScript', 72541, 13646, 67, 282, 1320, 635, 'MIT', ['ai-agent', 'ai-job-search', 'ats', 'career', 'careerops', 'claude-code', 'cli', 'cover-letter', 'cv', 'interview-prep', 'job-application', 'job-hunting', 'job-search', 'job-tracker', 'jobsearch', 'jobseekers', 'local-first', 'open-source', 'resume', 'resume-builder'], '2026-04-04'],
  ['tt-a1i/archify', 'archify', 'Agent skill for beautiful, verifiable architecture, workflow, sequence, data-flow, and lifecycle diagrams—self-contained HTML with motion and crisp export.', 'ai', 'JavaScript', 70709, 4751, 11, 807, 2523, 159, 'MIT', ['agent-skills', 'architecture-as-code', 'architecture-diagram', 'claude-skill', 'code-visualization', 'codex', 'coding-agents', 'data-flow-diagram', 'deepseek-harness', 'developer-tools', 'diagram-as-code', 'diagrams', 'diagrams-as-code', 'dsh-plugin', 'mermaid-alternative', 'opencode', 'sequence-diagram', 'software-architecture', 'system-design', 'text-to-diagram'], '2026-04-15'],
  ['diegosouzapw/OmniRoute', 'OmniRoute', 'Never stop coding. Free MIT AI gateway: one endpoint, 359 providers (150+ free), 1200+ models Kimi, Claude, GPT, Gemini, GLM, DeepSeek, MiniMax. Works with Claude Code, Codex, Cursor, OpenCode, Cline & Copilot. Quota-aware auto-fallback, RTK+Caveman compression saves 15-95% tokens, MCP/A2A, Desktop/PWA. Built by hundreds of contributors', 'ai', 'TypeScript', 69643, 9884, 6, 36, 429, 623, 'MIT', ['a2a', 'ai-agents', 'ai-gateway', 'anthropic', 'claude', 'claude-code', 'cline', 'codex', 'copilot', 'cursor', 'deepseek', 'free-ai', 'gemini', 'kimi', 'llm-gateway', 'mcp', 'openai', 'openai-proxy', 'qwen', 'token-saver'], '2026-02-13'],
  ['ZhuLinsen/daily_stock_analysis', 'daily_stock_analysis', 'LLM 驱动的多市场股票智能分析系统：多源行情、实时新闻、决策看板与自动推送，支持零成本定时运行。  LLM-powered multi-market stock analysis system with multi-source market data, real-time news, decision dashboard, automated notifications, and cost-free scheduled runs.', 'ai', 'Python', 65543, 54780, 11, 42, 493, 48, 'MIT', ['a-stock', 'ai-agent', 'aigc', 'llm', 'quant', 'quantitative-finance', 'quantitative-trading'], '2026-01-10'],
  ['mvanhorn/last30days-skill', 'last30days-skill', 'AI agent skill that researches any topic across Reddit, X, YouTube, HN, Polymarket, and the web - then synthesizes a grounded summary', 'ai', 'Python', 62726, 5461, 52, 314, 1426, 120, 'MIT', ['ai-prompts', 'ai-skill', 'bluesky', 'claude', 'claude-code', 'clawhub', 'deep-research', 'hackernews', 'instagram', 'openclaw', 'polymarket', 'recency', 'reddit', 'research', 'social-media', 'tiktok', 'trends', 'twitter', 'web-search', 'youtube'], '2026-01-23'],
  ['calesthio/OpenMontage', 'OpenMontage', 'World\'s first open-source, agentic video production system. 12 production pipelines, 100+ tools, 700+ agent skill and production-knowledge files. Turn your AI coding assistant into a full video production studio.', 'ai', 'Python', 61067, 7766, 46, 253, 945, 331, 'AGPL-3.0', ['agent', 'agentic-ai', 'ai', 'claude', 'copilot', 'cursor', 'elevenlabs', 'ffmpeg', 'flux', 'image-generation', 'open-source', 'openai', 'python', 'remotion', 'stable-diffusion', 'text-to-speech', 'text-to-video', 'video-generation', 'video-production'], '2026-03-29'],
  ...
  ['rohitg00/ai-engineering-from-scratch', 'ai-engineering-from-scratch', 'Learn it. Build it. Ship it for others.', 'ai', 'Python', 55795, 9852, 15, 241, 906, 59, 'MIT', ['agents', 'ai', 'ai-agents', 'ai-engineering', 'computer-vision', 'course', 'deep-learning', 'from-scratch', 'generative-ai', 'llm', 'machine-learning', 'mcp', 'nlp', 'python', 'reinforcement-learning', 'rust', 'swarm-intelligence', 'transformers', 'tutorial', 'typescript'], '2026-03-18'],
  ['jamiepine/voicebox', 'voicebox', 'The open-source AI voice studio. Clone, dictate, create.', 'ai', 'TypeScript', 55542, 6924, 15, 63, 463, 703, 'MIT', ['ai', 'cuda', 'mlx', 'qwen3-tts', 'qwen3-tts-ui', 'voice-ai', 'voice-clone', 'whisper'], '2026-01-25'],
  ['VoltAgent/awesome-openclaw-skills', 'awesome-openclaw-skills', 'The awesome collection of OpenClaw skills. 5,400+ skills filtered and categorized from the official OpenClaw Skills Registry.🦞', 'ai', 'Other', 52757, 5045, 9, 101, 752, 5, 'MIT', ['agent-skills', 'awesome', 'awesome-list', 'awesome-lists', 'clawd', 'clawdbot', 'clawdbot-skill', 'clawdhub', 'moltbot', 'moltbot-skills', 'openclaw', 'openclaw-skills'], '2026-01-25'],
  ['heygen-com/hyperframes', 'hyperframes', 'Write HTML. Render video. Built for agents.', 'ai', 'TypeScript', 52697, 4814, 52, 334, 2222, 199, 'Apache-2.0', ['ai', 'animation', 'ffmpeg', 'framework', 'gsap', 'html', 'mcp', 'puppeteer', 'rendering', 'typescript', 'video'], '2026-03-10'],
  ['blader/humanizer', 'humanizer', 'Agent skill that removes signs of AI-generated writing from text', 'ai', 'Python', 51692, 4138, 22, 136, 701, 25, 'MIT', ['agent-skills', 'ai-writing', 'claude-code', 'codex', 'cursor', 'prompt-engineering', 'writing-tools'], '2026-01-18'],
  ['multica-ai/multica', 'multica', 'Make humans and AI agents work as one team — open-source and self-hostable.', 'ai', 'Go', 51242, 6639, 12, 277, 779, 1674, 'NOASSERTION', [], '2026-01-13'],
  ['ayghri/i-have-adhd', 'i-have-adhd', 'A skill to stop your coding agent from burying the answer. ADHD-friendly output.', 'ai', 'Python', 50737, 2927, 16, 166, 938, 70, 'MIT', ['adhd', 'claude-', 'claude-code-plugin', 'claude-skills', 'developer-tools', 'productivity'], '2026-05-13'],
  ['HKUDS/CLI-Anything', 'CLI-Anything', '"CLI-Anything: Making ALL Software Agent-Native" -- CLI-Hub: https://clianything.cc/', 'ai', 'Python', 49998, 4603, 17, 98, 1104, 108, 'Apache-2.0', [], '2026-03-08'],
  ['Imbad0202/academic-research-skills', 'academic-research-skills', 'Academic Research Skills for Claude Code: research → write → review → revise → finalize', 'ai', 'Python', 49315, 3820, 10, 220, 1319, 34, 'NOASSERTION', ['academic-pipeline', 'academic-writing', 'ai-research', 'claude', 'claude-code', 'literature-review', 'peer-review', 'prompt-engineering'], '2026-02-26'],
  ['kepano/obsidian-skills', 'obsidian-skills', 'Agent skills for Obsidian. Teach your agent to use Obsidian CLI and open formats including Markdown, Bases, JSON Canvas.', 'ai', 'Other', 48816, 3478, 5, 25, 263, 73, 'MIT', ['agents', 'agentskills', 'bases', 'claude', 'clawdbot', 'cli', 'codex', 'defuddle', 'hermes', 'jsoncanvas', 'knap', 'markdown', 'md', 'obsidian', 'openclaw', 'opencode', 'skills'], '2026-01-02'],
  ['VoltAgent/awesome-design-md', 'awesome-design-md', 'A collection of DESIGN.md files analysis by popular brand design systems. Drop one into your project and let coding agents generate a matching UI.', 'developer-tools', 'Other', 117561, 13172, 2, 3, 3524, 311, 'MIT', ['awesome-list', 'design-md', 'design-system', 'design-tokens', 'figma', 'google-stitch', 'landing-page', 'vibe-coding', 'vibe-design', 'vibecoding'], '2026-03-31'],
  ['openai/symphony', 'symphony', 'Symphony turns project work into isolated, autonomous implementation runs, allowing teams to manage work instead of supervising coding agents.', 'developer-tools', 'Elixir', 27382, 2837, 57, 266, 1227, 8, 'Apache-2.0', [], '2026-02-26'],
  ['browser-use/video-use', 'video-use', 'Edit videos with coding agents', 'developer-tools', 'Python', 26566, 3168, 19, 146, 1175, 118, 'MIT', [], '2026-04-12'],
  ['edwardkim/rhwp', 'rhwp', '아래한글 hwp viewer and editor by rust and wasm', 'developer-tools', 'Rust', 3848, 727, 3, 21, 64, 114, 'MIT', ['hwp', 'hwpx', 'rust'], '2026-03-27'],
  ...
  ['devframes/devframe', 'devframe', 'Framework-neutral foundation for building generic DevTools.', 'developer-tools', 'TypeScript', 574, 21, 1, 7, 27, 14, 'MIT', ['devframe', 'devtools', 'framework', 'framework-agnostic'], '2026-05-07'],
  ...
  ['zhishile/codex-auth-helper', 'codex-auth-helper', 'Codex登陆助手：安全地在本地导出您的已登录 ChatGPT 会话配置，生成符合 Codex 规范的 auth.json 本地备份文件。', 'web', 'CSS', 16543, 640, 3, 16, 283, 81, 'NOASSERTION', [], '2026-06-02'],
  ['lnkiai/m3e-canvas', 'm3e-canvas', 'Sketch Material 3 Expressive screens in the browser and turn them into vibe-coding prompts.', 'web', 'TypeScript', 8098, 848, 5, 95, 424, 5, 'MIT', ['design-tool', 'material-3-expressive', 'material-design', 'material3', 'nextjs', 'prompt', 'react', 'vibe-coding'], '2026-09-02'],
  ...
  ['MengTo/threeui', 'threeui', 'Open-source ThreeUI Community catalog with live interactive components and complete Community source.', 'web', 'HTML', 6134, 590, 0, 48, 136, 9, 'MIT', ['react', 'shaders', 'threejs', 'ui-components', 'webgl'], '2026-08-21'],
  ...
  ['asciimoo/hister', 'hister', 'Your own search engine', 'web', 'Go', 5631, 241, 9, 37, 171, 64, 'AGPL-3.0', ['browser-history', 'go', 'golang', 'history', 'index', 'mcp', 'mcp-server', 'personal-search', 'personal-search-engine', 'privacy', 'search', 'search-engine', 'semantic-search', 'web'], '2026-01-04'],
  ['Achilng/floral-notepaper', 'floral-notepaper', '花笺，轻量优雅的跨平台桌面便签工具，支持 Markdown 编辑与预览', 'web', 'Rust', 5280, 305, 8, 50, 245, 138, 'MIT', ['macos', 'markdown', 'note-taking', 'react', 'rust', 'sticky-notes', 'tauri', 'windows'], '2026-04-26'],
  ...
  ['guokaigdg/animal-island-ui', 'animal-island-ui', 'A Kawaii React UI component library  一个可爱的 React UI 组件库', 'web', 'TypeScript', 4661, 14, 5, 29, 83, 4, 'NOASSERTION', ['component-library', 'react', 'typescript', 'ui-components', 'ui-design'], '2026-04-12'],
  ['crafter-station/petdex', 'petdex', 'A public gallery of animated pets for Codex, Claude Code, DeepSeek Harness, Hermes, OpenCode, Gemini CLI, and more.', 'web', 'TypeScript', 4154, 207, 13, 56, 243, 28, 'MIT', ['claude-code', 'clerk', 'cli', 'codex', 'developer-tools', 'drizzle-orm', 'dsh-plugin', 'mascot', 'neon', 'nextjs', 'pixel-art', 'postgres', 'react', 'sprites', 'tailwindcss', 'vercel'], '2026-05-02'],
  ...
  ['zenbu-labs/terminal-browser', 'terminal-browser', 'A browser inside your terminal', 'web', 'TypeScript', 3222, 153, 4, 16, 109, 67, 'MIT', ['browser', 'claude-code', 'claude-code-plugin', 'claude-skills', 'cli', 'codex', 'herdr-plugin', 'rust', 'terminal', 'web'], '2026-07-06'],
  ...
  ['floci-io/floci', 'floci', 'Light, fluffy, and always free - The AWS Local Emulator alternative', 'infra', 'Java', 25406, 2751, 25, 248, 839, 109, 'MIT', ['aws', 'aws-emulation', 'devops', 'docker', 'ec2', 'ecs', 'localstack', 's3', 'sqs', 'testcontainers'], '2026-02-18'],
  ['caamer20/Telegram-Drive', 'Telegram-Drive', 'Turn your Telegram account into an unlimited, secure cloud storage drive. an Open-source desktop app built with Tauri, Rust, and React.', 'infra', 'TypeScript', 5188, 794, 0, 7, 199, 0, 'NOASSERTION', ['open-source', 'react', 'rust', 'tauri', 'telegram', 'telegramapi', 'typescript'], '2026-01-23'],
  ['CJackHwang/ds2api', 'ds2api', 'DeepSeek-Compatible Middleware Interface: A technical exploration project in Go, focusing on high-concurrency protocol adaptation. It serves as a reference implementation for converting diverse web protocols into standardized formats.', 'infra', 'Go', 4742, 1644, 2, 9, 142, 30, 'AGPL-3.0', ['api', 'claude-api', 'deepseek', 'deepseek-api', 'docker', 'freeapi', 'go', 'openai-api', 'proxy', 'proxy-server', 'react', 'vercel', 'vercel-deployment', 'zeabur'], '2026-01-21'],
  ['ministackorg/ministack', 'ministack', 'Ministack: Free, open-source local AWS emulator - 60+ services, Terraform compatible, real databases. Free forever. MIT   licensed.', 'infra', 'Python', 4678, 458, 0, 15, 199, 17, 'MIT', ['aws', 'aws-emulator', 'aws-local', 'aws-sdk', 'devtools', 'docker', 'dynamodb', 'ec2', 'emulator', 'lambda', 'localstack', 'localstack-alternative', 'ministack', 'mock-aws', 'open-source', 'python', 's3', 'sqs', 'terraform'], '2026-03-24'],
  ...
  ['DuarteSantos8/openGym', 'openGym', 'Self-hosted gym & body-weight tracker — plan routines, log workouts (supersets, warm-ups, cardio), see which muscles are trained, fatigued or detrained, import from FitNotes/Strong/Hevy, passkey login. Your data, your server.', 'data', 'JavaScript', 1302, 307, 1, 2, 22, 138, 'AGPL-3.0', ['bodyweight', 'docker', 'fitness', 'fitness-tracker', 'gym', 'health', 'mcp', 'nodejs', 'passkeys', 'progressive-web-applications', 'pwa', 'react', 'self-hosted', 'self-hosting', 'vite', 'webauthn', 'weightlifting', 'workout-tracker'], '2026-07-18'],
  ['ModernRelay/omnigraph', 'omnigraph', 'Lakehouse native graph engine with git-style workflows', 'data', 'Rust', 1197, 256, 0, 5, 47, 67, 'MIT', ['apache-arrow', 'context-graph', 'datafusion', 'graph-database', 'knowledge-graph', 'lakehouse', 'lance', 'mcp', 'rust', 's3', 'versioning'], '2026-04-10'],
  ...
  ['RavelloH/InsightFlare', 'InsightFlare', 'A powerful, privacy-friendly open source web analytics tool that runs entirely on Cloudflare.', 'data', 'TypeScript', 501, 13, 0, 3, 21, 1, 'MIT', ['analytics', 'cloudflare', 'cloudflare-workers', 'cookieless', 'durable-objects', 'edge-computing', 'gdpr-compliant', 'nextjs', 'privacy-first', 'react', 'serverless', 'typescript', 'web-analytics'], '2026-02-28'],
  ...
  ['PerryTS/perry', 'perry', 'A native TypeScript/JavaScript compiler written in Rust. Compiles TypeScript/JavaScript directly to executables using SWC and LLVM.', 'mobile', 'Rust', 4888, 163, 6, 44, 224, 276, 'MIT', ['android', 'compile', 'harmonyos', 'ios', 'llvm', 'macos', 'native', 'smc', 'typescript', 'watchos', 'windows'], '2026-01-19'],
  ...
  ['software-mansion/argent', 'argent', 'An agentic toolkit to control, debug, and profile iOS and Android apps. Made by Software Mansion.', 'mobile', 'TypeScript', 2884, 121, 1, 4, 71, 333, 'Apache-2.0', ['agentic', 'android', 'ios', 'react-native'], '2026-02-23'],
  ['Shrey113/Android-Dex', 'Android-Dex', 'Universal Samsung DeX alternative for all Android devices. Run Android apps on Windows, Linux & macOS with resizable windows, advanced FPS gaming controls, and high-performance wireless ADB mirroring.', 'mobile', 'HTML', 2657, 202, 1, 2, 67, 24, 'NOASSERTION', ['adb', 'android-dex', 'android-gaming', 'desktop', 'desktop-environment', 'flutter', 'game', 'keymapper', 'samsung-devices', 'samsung-dex', 'scrcpy', 'scrcpy-gui', 'screen-mirroring', 'wireless-debugging'], '2026-02-02'],
  ...
  ['pass-with-high-score/blockads-android', 'blockads-android', 'Block ads system-wide on Android using local VPN-based DNS filtering. No root needed. No data collection.', 'mobile', 'Kotlin', 2064, 116, 0, 5, 9, 69, 'GPL-3.0', ['adblocker', 'android', 'block-ads', 'blockads', 'dns', 'dns-filter', 'firewall', 'go-mobile', 'golang', 'https-filtering', 'jetpack-compose', 'kotlin', 'no-root', 'privacy', 'root', 'vpn', 'wireguard'], '2026-02-10'],
  ...
  ['anywhere-labs/dsh-desktop', 'dsh-desktop', '为 DeepSeek Harness (DSH) 插件生态打造的现代化桌面端解决方案。万物皆「插件」，桌面本身也是「插件」。', 'productivity', 'TypeScript', 28734, 1365, 0, 19, 178, 354, 'MIT', ['cordis', 'cordis-plugin', 'deepseek', 'deepseek-harness', 'desktop', 'dsh', 'dsh-plugin', 'dsh-plugin-desktop'], '2026-08-13'],
  ['jarrodwatts/claude-hud', 'claude-hud', 'A Claude Code plugin that shows what\'s happening - context usage, active tools, running agents, and todo progress', 'productivity', 'JavaScript', 28140, 1302, 26, 252, 1663, 32, 'MIT', ['anthropic', 'claude', 'claude-code', 'cli', 'plugin', 'statusline', 'typescript'], '2026-01-02'],
  ...
  ['modem-dev/hunk', 'hunk', 'Review-first terminal diff viewer for agentic coders', 'productivity', 'TypeScript', 9371, 308, 12, 56, 156, 169, 'MIT', ['agents', 'cli', 'code-review', 'diff', 'git', 'jj', 'jujutsu', 'sapling', 'terminal', 'tui'], '2026-03-17'],
  ...
  ['Tianyu199509/DeskBox', 'DeskBox', 'A free, open-source Windows desktop organizer with native-feeling WinUI 3 widgets.', 'productivity', 'C#', 5099, 281, 19, 98, 261, 72, 'GPL-3.0', ['desktop-cleanup', 'desktop-organizer', 'desktop-widget', 'desktop-widgets', 'dotnet10', 'file-management', 'file-organization', 'file-organizer', 'open-source', 'productivity', 'tray-app', 'windows', 'windows-11', 'windows-app-sdk', 'windows-desktop', 'windows-tool', 'winui', 'winui-3', 'winui3'], '2026-06-11'],
  ['fallow-rs/fallow', 'fallow', 'Codebase intelligence for TypeScript and JavaScript. Free static analysis of code and styles: unused code, duplication, circular deps, complexity hotspots, architecture boundaries, design-system drift. Optional paid runtime layer (Fallow Runtime): hot-path review and cold-path deletion evidence from real production traffic.', 'productivity', 'Rust', 4844, 163, 2, 58, 226, 44, 'MIT', ['cli', 'code-duplication', 'code-quality', 'codebase-intelligence', 'copy-paste-detection', 'dead-code', 'developer-tools', 'duplicate-code', 'javascript', 'linter', 'oxc', 'runtime-intelligence', 'rust', 'static-analysis', 'typescript', 'unused-code', 'unused-dependencies', 'unused-exports'], '2026-03-17'],
  ['Jia-Ethan/codex-keysmith', 'codex-keysmith', 'Versioned Codex instruction deployment with preview, ownership manifests, hook isolation, scenario evaluation, and recovery.', 'productivity', 'Python', 4586, 717, 1, 3, 32, 5, 'MIT', ['cli', 'codex', 'codex-cli', 'configuration-management', 'developer-tools', 'local-first', 'prompt-engineering', 'python'], '2026-06-28'],
  ['crmne/spotifast', 'spotifast', 'Spotify, native and fast. One lightweight Rust app for your whole library, local playback, and Spotify Connect on Linux, macOS, and Windows.', 'productivity', 'Rust', 4562, 209, 2, 29, 220, 42, 'MIT', ['audio', 'cross-platform', 'desktop-app', 'egui', 'gui', 'librespot', 'linux', 'macos', 'mpris', 'music', 'music-player', 'rust', 'spotify', 'spotify-client', 'spotify-connect', 'windows'], '2026-08-27'],
];
